...
Camera2 physical ID 3 проверен на RAW 4096x3072. По семи измеренным ступеням
...
с допуском 1.5% для дискретности сенсора. Другие physical ID пока отвергаются:
их коэффициенты нельзя объявлять проверенными по измерениям камеры 3.
...
На телефоне дважды выполнен настоящий production VivoStockAe/JNI + Camera2:
...
осиротевшего процесса. Диагностический запуск через DEX не собирал APK и
