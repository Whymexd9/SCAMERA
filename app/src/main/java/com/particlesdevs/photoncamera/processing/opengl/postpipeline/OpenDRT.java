...
public class OpenDRT extends Node {
    ...
    @Tunable(category = "OpenDRT", defaultValue = 10.0f, description = "OpenDRT display grey luminance", max = 25.0f, min = 3.0f, step = 0.1f, title = "Display Grey (nits)")
    float displayGrey;
    ...
    @Tunable(category = "OpenDRT", defaultValue = 0.5f, description = "OpenDRT purity-compression blend from 100 to 1000 nit display peaks", max = 1.0f, min = 0.0f, step = 0.01f, title = "HDR Purity")
    float hdrPurity;

    @Tunable(category = "OpenDRT", defaultValue = 0.0f, description = "0 Standard, 1 Arriba, 2 Sylvan, 3 Colorful, 4 Aery, 5 Dystopic, 6 Umbra", max = 6.0f, min = 0.0f, step = 1.0f, title = "Look Preset")
    int lookPreset;

    @Tunable(category = "OpenDRT", defaultValue = 0.003f, description = "OpenDRT shadow toe", max = 0.1f, min = 0.0f, step = 0.001f, title = "Toe")
    float toe;
