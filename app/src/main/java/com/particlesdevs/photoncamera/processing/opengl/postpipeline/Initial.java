...
import static com.particlesdevs.photoncamera.util.Math2.mix;
    ...
    public void Run() {
        ...
        glProg.setDefine("ACES_EXPOSURE", PreferenceKeys.getAcesExposure());
        glProg.setDefine("ACES_PEAK", PreferenceKeys.getAcesPeak());
        glProg.setDefine("ACES_GAMUT", PreferenceKeys.getAcesGamut());
        glProg.setDefine("ACES_HIGHLIGHT_DESAT", PreferenceKeys.getAcesHighlightDesat());
        glProg.setDefine("ACES_SURROUND", PreferenceKeys.getAcesSurround());
        glProg.setDefine("ACES_TONE_CURVE", Integer.toString(PreferenceKeys.getAcesToneCurve()));
        glProg.setDefine("ACES_GAMMA_CURVE", Integer.toString(PreferenceKeys.getAcesGammaCurve()));
        glProg.setDefine("ACES_TONE_MIX", PreferenceKeys.getAcesToneMix());
        glProg.setDefine("ACES_MID_GRAY", PreferenceKeys.getAcesMidGray());
        glProg.setDefine("ACES_TONE_CONTRAST", PreferenceKeys.getAcesToneContrast());
        glProg.setDefine("ACES_TOE", PreferenceKeys.getAcesToe());
        glProg.setDefine("ACES_SHOULDER", PreferenceKeys.getAcesShoulder());
        glProg.setDefine("ACES_HUE_PROTECTION", PreferenceKeys.getAcesHueProtection());
        glProg.setDefine("ACES_CUSTOM_GAMMA", PreferenceKeys.getAcesCustomGamma());
        glProg.setDefine("DARKTABLE_ENABLED", ScameraPreferences.darktableEnabled());
        glProg.setDefine("DT_EXPOSURE", ScameraPreferences.darktableExposure());
        glProg.setDefine("DT_FILMIC_CONTRAST", ScameraPreferences.darktableFilmicContrast());
        glProg.setDefine("DT_SHADOWS", ScameraPreferences.darktableShadows());
        glProg.setDefine("DT_HIGHLIGHTS", ScameraPreferences.darktableHighlights());
        glProg.setDefine("DT_LOCAL_CONTRAST", ScameraPreferences.darktableLocalContrast());
        glProg.setDefine("DT_COLORFULNESS", ScameraPreferences.darktableColorfulness());
        glProg.setDefine("DT_HIGHLIGHT_RECON", ScameraPreferences.darktableHighlightReconstruction());
        glProg.setDefine("DT_DIFFUSE_SHARPEN", ScameraPreferences.darktableDiffuseSharpen());
        glProg.setDefine("DT_PROFILED_DENOISE", ScameraPreferences.darktableProfiledDenoise());
        glProg.setDefine("DT_TONE_SHADOWS", ScameraPreferences.darktableToneShadows());
        glProg.setDefine("DT_TONE_MIDTONES", ScameraPreferences.darktableToneMidtones());
        glProg.setDefine("DT_TONE_HIGHLIGHTS", ScameraPreferences.darktableToneHighlights());
        glProg.setDefine("DT_BALANCE_SHADOWS", ScameraPreferences.darktableBalanceShadows());
        glProg.setDefine("DT_BALANCE_MIDTONES", ScameraPreferences.darktableBalanceMidtones());
        glProg.setDefine("DT_BALANCE_HIGHLIGHTS", ScameraPreferences.darktableBalanceHighlights());
        glProg.setDefine("DT_COLOR_RECON", ScameraPreferences.darktableColorReconstruction());
        glProg.setDefine("DT_CALIB_TEMP", ScameraPreferences.darktableCalibrationTemperature());
        glProg.setDefine("DT_CALIB_TINT", ScameraPreferences.darktableCalibrationTint());
        glProg.setDefine("DT_COLOR_RED", ScameraPreferences.darktableColorRed());
        glProg.setDefine("DT_COLOR_GREEN", ScameraPreferences.darktableColorGreen());
        glProg.setDefine("DT_COLOR_BLUE", ScameraPreferences.darktableColorBlue());
        glProg.setDefine("DT_WIDE_CA", ScameraPreferences.darktableWideCa());
        glProg.setDefine("DT_VIGNETTE", ScameraPreferences.darktableVignette());
        glProg.setDefine("DT_HAZE", ScameraPreferences.darktableHazeRemoval());
        glProg.setDefine("DT_TEXTURE", ScameraPreferences.darktableTexture());
