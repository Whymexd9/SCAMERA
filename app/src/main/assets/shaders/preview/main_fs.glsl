...
void main() {
    ...
    if (uLookEnabled) {
        // LiveSceneMeter derives this response in the display domain of the ISP stream.
        // Decoding gamma here would darken the stream before an encoded-domain curve.
        vec3 lin = clamp(color.rgb, 0.0, 1.0);
